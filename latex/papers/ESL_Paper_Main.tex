...
Our findings show that language models understand epistemic rules (ESL is syntactically followed) but do not reliably enforce them. Prompting remains interpretive, not executive. This parallels mature safety-critical domains: aviation uses checklists rather than pilot intuition; medicine uses diagnostic protocols rather than clinical impression. When reliability matters, control must be externalized from the interpretive system.
