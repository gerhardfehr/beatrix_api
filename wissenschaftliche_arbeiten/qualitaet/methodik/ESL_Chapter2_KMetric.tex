...
\title{%
    ...
    \large Mathematical Foundations, Properties, and Proofs
}
...
\begin{abstract}
\noindent
This chapter presents the complete mathematical foundations of the K-metric, ESL's central formalization for measuring claim-evidence alignment. We begin with axiomatic foundations, deriving the K-metric from first principles of calibration measurement. We prove key properties including boundedness, monotonicity, symmetry conditions, and behavior under composition. The chapter introduces three K-metric variants (standard, asymmetric, and weighted) suited to different applications. We analyze the metric's geometric interpretation in B-E space, establish continuity and differentiability properties, and derive error propagation formulas for uncertainty quantification. The chapter concludes with computational considerations and connections to related metrics in information theory and decision science.

\vspace{0.5em}
\noindent\textbf{Keywords:} K-metric, calibration measurement, claim-evidence alignment, mathematical foundations, metric properties, error propagation
\end{abstract}
...
This chapter has established the mathematical foundations of the K-metric:
...
\begin{eslbox}
\textbf{Chapter 2 Self-Assessment}

This chapter presents mathematical definitions and proofs ($B \approx 0.85$) derived through formal reasoning ($E \approx 0.90$ for mathematical content by construction).
