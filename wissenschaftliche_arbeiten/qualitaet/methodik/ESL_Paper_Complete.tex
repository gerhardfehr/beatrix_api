...
\noindent {\small $^\dagger$ Empirically derived from N=80 validated claims (Appendices C--E). CI via SE = Gap$/2\sqrt{N}$}
...
Mixed/Borderline: 3/3 correctly flagged \\
Confirmed replications: 21/21 correctly classified as Stable \\[0.5em]
\textbf{Total Cross-Disciplinary Accuracy: 80/80 = 100\%}
}}
\end{center}
...
\begin{itemize}
    ...
    \item $E_{\max} = 0.95$
    \item Strength: Three disciplines, N=80, objective outcomes
    \item Includes 6 key authors: Kahneman/Tversky, Thaler, Fehr, Camerer, Loewenstein, Ariely
    \item Limitation: Retrospective, selection of influential papers
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Total cross-disciplinary validation: 80/80 = 100\% accuracy}
\end{itemize}
