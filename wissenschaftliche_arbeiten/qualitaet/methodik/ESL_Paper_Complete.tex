...
$K_{\text{stable}}$ Medicine, Psychology & T4 & \textcolor{orange}{Proposed} & Expert estimate \\
...
A framework claiming to measure epistemic calibration must be transparent about its own epistemic status. This section documents that ESL contains both validated and proposed components. \textbf{Update:} $B$-values have been upgraded from T5 (Author Intuition) to T3 (LLM-Calibrated) based on systematic analysis of N=27 claims with known outcomes. Remaining proposed parameters (triangulation bonuses, Medicine/Psychology thresholds) should be treated as starting points for local calibration.
\end{insightbox}
