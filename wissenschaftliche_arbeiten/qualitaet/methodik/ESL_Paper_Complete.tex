...
$B$-values for linguistic markers & T5 & \textcolor{red}{Unvalidated} & Ordinal intuition \\
...
A framework claiming to measure epistemic calibration must be transparent about its own epistemic status. This section documents that ESL contains both validated and proposed components. Users should weight ESL outputs accordingly: validated thresholds (Physics, Economics, Behavioral Economics) provide reliable classification; proposed parameters ($B$-values, triangulation bonuses) should be treated as starting points for local calibration.
\end{insightbox}
