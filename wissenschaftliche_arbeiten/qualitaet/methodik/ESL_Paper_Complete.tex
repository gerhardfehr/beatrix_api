...
\begin{itemize}
    \item Validated B-values (requires corpus studies or MC validation)
    \item Calibrated K-thresholds (requires outcome prediction studies)
    \item Predictive validity evidence
\end{itemize}
