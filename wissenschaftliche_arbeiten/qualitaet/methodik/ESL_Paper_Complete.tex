...
\noindent\textbf{Final Self-Assessment Summary (ESL 2.0)}
...
\begin{itemize}
    ...
    \item \textbf{Cluster 2} (Framework: B-values, thresholds): $K = 0.08$
    \item \textbf{Document}: $K = 0.30 \times 0.81 + 0.70 \times 0.08 = 0.30$
\end{itemize}
...
\begin{itemize}
    \item Validated B-values (requires corpus studies)
    \item Calibrated K-thresholds (requires outcome prediction studies)
    \item Predictive validity evidence
\end{itemize}

\textbf{The key insight}: ESL 1.0 failed at self-assessment because it lacked structural safeguards. ESL 2.0's five mechanisms (CTC, PP, WLA, EVA, RAS) create mathematical barriers against inflation---barriers that this paper itself cannot circumvent.

\vspace{1em}
\begin{center}
\fbox{\parbox{0.85\textwidth}{
\centering
\textbf{Core Principle:} \\[0.3em]
\textit{``An honest framework must \textbf{enforce} honesty, not merely recommend it.''}
}}
\end{center}
