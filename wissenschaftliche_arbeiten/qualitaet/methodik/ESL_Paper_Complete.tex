...
\textbf{Part III: Validation} (Sections 10--13, Appendices C--E) presents the structural safeguards (ESL 2.0), Monte-Carlo validation (ESL 2.1), and empirical validation across Physics, Economics, and Behavioral Economics (N=115).

\textbf{Part IV: Applications} demonstrates ESL's utility through three case studies:
\begin{itemize}
...
\addcontentsline{toc}{part}{Part IV: Applications}
...
% =============================================================================
% PART III: VALIDATION & SAFEGUARDS
% =============================================================================

\part*{Part III: Validation and Safeguards}
\addcontentsline{toc}{part}{Part III: Validation and Safeguards}

\begin{center}
\fbox{\parbox{0.9\textwidth}{
\centering
\textbf{From Theory to Empirical Validation} \\[0.5em]
Part III presents ESL's self-critical evolution:
\begin{itemize}[noitemsep]
