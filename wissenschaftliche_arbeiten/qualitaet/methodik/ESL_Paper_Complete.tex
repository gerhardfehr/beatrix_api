...
\textbf{Applications:} We demonstrate ESL's utility through three case studies: (1) the \textbf{Behavioral Change Model (BCM)}---a parameter registry for behavioral interventions, (2) \textbf{BEATRIX}---an AI-assisted behavioral analysis system, and (3) \textbf{Literature ESL}---author and genre classification (N=35 authors, $r=0.98$ validation).
...
\textbf{Part III: Applications} demonstrates ESL's utility through three case studies:
\begin{itemize}
