...
\begin{warningbox}[title={Scope: Empirical Studies}]
The evidence hierarchies in this chapter apply to \textbf{empirical studies} (paper type: EMP). Other paper types---meta-analyses (META), theoretical papers (THE), reviews (REV), methods papers (METH), etc.---have their own E-scales defined in \textbf{Appendix F: Paper Type Classification}. The K-metric is universally applicable; only the E-scale differs by paper type.
\end{warningbox}
...
\begin{enumerate}
    ...
    \item \textbf{Paper Type Extension}: These hierarchies apply to empirical studies. For meta-analyses, theoretical papers, methods papers, and other publication types, see Appendix F.
\end{enumerate}
